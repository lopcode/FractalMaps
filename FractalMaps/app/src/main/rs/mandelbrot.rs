#pragma version(1)
#pragma rs java_package_name(io.bunnies.fractalmaps.compute.strategies.renderscript)
...
//int32_t __attribute__((kernel)) kernel(int32_t v_in, uint32_t x, uint32_t y) {
